...
const Accounting = React.memo(
  ({ accounts, newAccount, setNewAccount, addNewAccount, t }) => {
    ...
    // Memoize sorted accounts to prevent re-sorting on every render
          ...
          <table className="w-full divide-y divide-neutral-700">
            <thead className={`${t.tableHeader} sticky top-0 z-10`}>
              <tr>
                ...
                <th className="px-3 py-2 text-center text-xs font-mono uppercase w-24">
                  <div className="flex items-center justify-center gap-1">
                    <span className="text-cyan-400 opacity-70">ACC</span>
                    <span>No.</span>
                  </div>
                </th>
              </tr>
