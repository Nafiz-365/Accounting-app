...
const JournalEntryForm = ({
  ...
  const currentLines = useMemo(() => currentEntry.lines || [], [currentEntry]);
  ...
  return (
    <div className={`rounded-xl ${t.cardBg} ${t.shadow} p-6 ${t.border}`}>
      <h2 className={`text-2xl font-bold ${t.secondaryAccent} mb-6`}>
        {title}
      </h2>
      ...
      <div className="space-y-4 mb-4">
        {currentLines.map((line, index) => {
          ...
          const amount =
            entryType === "debit" ? line.debit || "" : line.credit || "";
          ...
          return (
            <div key={index} className="space-y-3">
              ...
              <div className="relative">
                ...
                <div className="relative">
                  <input
                    ...
                    value={searchText}
                    onChange={(e) =>
                      handleAccountTextChange(index, e.target.value)
                    }
                    placeholder="Search account name or code"
                    // Use extra padding for the icon
                    className={`w-full px-3 py-2 pl-10 border rounded-lg transition-colors ${
                      t.input
                    } ${isAccountSelected ? "font-medium text-cyan-400" : ""}`}
              ...
              {/* Debit/Credit, Amount, and Delete Button Row */}
              <div className="grid grid-cols-12 gap-2 items-center">
                ...
                <div className="col-span-5">
                  <select
                    value={entryType}
                    onChange={(e) =>
                      handleEntryTypeChange(index, e.target.value)
                    }
                ...
                <div className="col-span-5">
                  <input
                    ...
                    className={`w-full px-3 py-2 border rounded-lg ${
                      ...
                      entryType === "debit" ? "text-lime-400" : "text-cyan-400"
                    }`}
                  />
                </div>
                ...
                <div className="col-span-2 flex justify-center">
                  <button
                    ...
                    disabled={currentLines.length <= 1}
                    className={`group relative p-2 rounded-lg transition-all duration-300 ${
                      currentLines.length <= 1
                        ? "text-gray-500 cursor-not-allowed opacity-50"
                        : "text-red-400 hover:text-red-300 hover:bg-red-500/20 hover:scale-110"
                    }`}
                    title={
                      currentLines.length <= 1
